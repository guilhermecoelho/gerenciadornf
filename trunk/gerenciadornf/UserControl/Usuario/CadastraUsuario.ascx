<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CadastraUsuario.ascx.cs"
    Inherits="gerenciadornf.UserControl.Usuario.CadastraUsuario" %>
<asp:ValidationSummary ID="ValidationSummary1" runat="server" ValidationGroup="Cadastro" />
<br />
<asp:RequiredFieldValidator ID="rfvNome" ControlToValidate="txtNome" ValidationGroup="Cadastro"
...
<asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="txtSenha"
    ValidationGroup="Cadastro" runat="server" ErrorMessage="Informe uma Senha" Display="Dynamic">*</asp:RequiredFieldValidator>
